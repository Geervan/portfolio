    ...
    const projects = [
        {
            ...
            description: "A zero-knowledge bridge connecting browser AI chats (ChatGPT, Claude, Gemini) with VS Code. It securely captures, encrypts (AES-256), and syncs architectural context and code snippets directly to your IDE in real-time.",
        ...
        },
        {
            ...
            description: "A local-first portable IDE pairing a React PWA client with a secure Node.js host daemon. Renders real terminal sessions, handles proxy dev servers, and runs code securely from any device via Cloudflare Tunnels.",
